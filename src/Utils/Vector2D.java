...
public class Vector2D {
    ...
    public static final Vector2D xVector = new Vector2D(1, 0);
    public static final Vector2D yVector = new Vector2D(0, 1);
    public static Vector2D infVector = new Vector2D(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
